...
from KiaraConfig.config import Config
...
class Development(Config):
    ...
    BOT_LIBRARY = "telethon"  # fill 'pyrogram' if you want pyrogram version of kiarabot else leave it as it is.
    DATABASE_URL = "Your value"  # A postgresql database url from elephantsql
    KIARABOT_SESSION = "Your value"  # telethon or pyrogram string according to BOT_LIBRARY
