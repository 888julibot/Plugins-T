...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "Kiara_X_Upadates")
    ...
    KIARABOT_SESSION = os.environ.get("KIARABOT_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./KiaraConfig/resources/pics/kiarabot_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/The-KiaraBot/KiaraBot")
    ...
    SUDO_USERS = []
    TELEGRAPH_NAME = os.environ.get("TELEGRAPH_NAME", "[ †he Ừʂɛɤẞø† ]")
