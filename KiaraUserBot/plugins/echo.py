...
from KiaraUserBot.DB.echo_sql import (addecho, get_all_echos, is_echo,
                                      remove_echo)
from KiaraUserBot.DB.gvar_sql import addgvar, gvarstat
from KiaraUserBot.plugins import *


@kiara_cmd(pattern="echo$")
async def echo(event):
    if event.reply_to_msg_id is not None:
        ForGo10God, kiara_USER, kiara_mention = await client_id(event)
