...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Me: Hello this is` `{kiara_mention}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: Hello Sir, How are you!!`",
        "`Prime Minister: May I Know Who Is This?`",
        f"`Me: Yes sur, itz me` `{kiara_mention}`",
