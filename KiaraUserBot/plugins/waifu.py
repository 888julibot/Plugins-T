...
async def _(event):
    ...
    if owo in neko_category:
        kiara = await eor(event, f"`Searching {owo} ...`")
        link = nekos.img(owo)
        ...
        kiara = await eor(event, "`Searching randoms...`")
