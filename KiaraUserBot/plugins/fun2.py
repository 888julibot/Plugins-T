...
@kiara_cmd(pattern="cat$")
async def hmm(kiara):
    reactcat = nekos.textcat()
    await eor(kiara, reactcat)


@kiara_cmd(pattern="why$")
async def hmm(kiara):
    whykiara = nekos.why()
    await eor(kiara, whykiara)


@kiara_cmd(pattern="fact$")
async def hmm(kiara):
    factkiara = nekos.fact()
    await eor(kiara, factkiara)
