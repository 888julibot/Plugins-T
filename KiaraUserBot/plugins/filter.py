...
from KiaraUserBot.DB.filter_sql import (add_filter, get_all_filters,
...
@kiara_cmd(pattern="filter(?:\s|$)([\s\S]*)")
...
@kiara_cmd(pattern="rmallfilters$")
