...
@kiara_cmd(pattern="sthink(?:\s|$)([\s\S]*)")
async def kraken(event):
    _, _, kiara_mention = await client_id(event)
    name = event.pattern_match.group(1)
    B = (
...
@kiara_cmd(pattern="strump(?:\s|$)([\s\S]*)")
...
@kiara_cmd(pattern="schina(?:\s|$)([\s\S]*)")
...
@kiara_cmd(pattern="monster$")
async def _(monster):
    await eor(monster, G)


@kiara_cmd(pattern="pig$")
async def _(pig):
    await eor(pig, H)


@kiara_cmd(pattern="gun$")
async def _(gun):
    await eor(gun, I)


@kiara_cmd(pattern="dog$")
async def _(dog):
    await eor(dog, J)


@kiara_cmd(pattern="hello$")
async def _(hello):
    await eor(hello, K)


@kiara_cmd(pattern="hmf$")
async def _(hmf):
    await eor(hmf, L)


@kiara_cmd(pattern="couple$")
async def _(couple):
    await eor(couple, M)


@kiara_cmd(pattern="sup$")
async def _(supreme):
    await eor(supreme, N)


@kiara_cmd(pattern="india$")
async def _(event):
    await eor(event, O)


@kiara_cmd(pattern="wc$")
async def _(welcome):
    await eor(welcome, P)


@kiara_cmd(pattern="snk$")
async def _(snake):
    await eor(snake, Q)


@kiara_cmd(pattern="bye$")
async def _(bye):
    await eor(bye, R)


@kiara_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@kiara_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
