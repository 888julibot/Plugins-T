...
@kiara_cmd(pattern="sing$")
async def _(e):
    txt = random.choice(SONGS)
    await eor(e, txt)


@kiara_cmd(pattern="hpotter$")
async def _(e):
    txt = random.choice(HARRY)
    await eor(e, txt)


@kiara_cmd(pattern="gott$")
async def _(e):
    txt = random.choice(GOTT)
    await eor(e, txt)


@kiara_cmd(pattern="gotm$")
async def _(e):
    txt = random.choice(GOTM)
    await eor(e, txt, link_preview=True)


@kiara_cmd(pattern="bello$")
async def _(e):
    txt = random.choice(BELLO)
    await eor(e, txt)


@kiara_cmd(pattern="tip$")
async def _(e):
    txt = random.choice(TIPS)
    await eor(e, txt)


@kiara_cmd(pattern="qt$")
async def _(e):
    txt = random.choice(QT)
    await eor(e, txt)


@kiara_cmd(pattern="logic$")
async def _(e):
    txt = random.choice(LOGIC)
    await eor(e, txt)


@kiara_cmd(pattern="snow$")
async def _(e):
    txt = random.choice(SNOW)
    await eor(e, txt)


@kiara_cmd(pattern="shayri$")
async def _(e):
    _, _, kiara_mention = await client_id(e)
    txt = random.choice(SHAYRI)
    await eor(e, txt.format(kiara_mention))


@kiara_cmd(pattern="hflirt$")
async def _(e):
    _, _, kiara_mention = await client_id(e)
