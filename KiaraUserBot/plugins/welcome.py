...
from KiaraUserBot.DB.welcome_sql import (add_welcome, get_current_welcome,
...
@kiara_cmd(pattern="savewelcome(?:\s|$)([\s\S]*)")
...
@kiara_cmd(pattern="cleanwelcome$")
...
@kiara_cmd(pattern="welcome_note$")
